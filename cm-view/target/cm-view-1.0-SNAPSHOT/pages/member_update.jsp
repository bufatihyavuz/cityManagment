    ...
    <div class="portlet">
        ...
        <div class="portlet-body form">
            ...
            <form:form role="form" method="POST" commandName="member" class="form-horizontal"
                       action="${pageContext.request.contextPath}/member_update/${member.id}">
                <div class="form-body">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input name="phone1" value="${phone1}" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">Telefon2</label>
                                <div class="col-md-9">
                                    <input name="phone2" value="${phone2}" class="form-control"/>
                                </div>
                            </div>
                        </div>
                    </div>
