...
<div class="tab-pane" id="tab_2">
    ...
    <div class="portlet">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa icon-plus"></i>Araç Güncelle
            </div>
        </div>
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <form:form role="form" method="POST" commandName="vehicle" class="form-horizontal"
                       action="${pageContext.request.contextPath}/vehicle_update/${vehicle.id}">
            <div class="form-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <form:input path="brand" class="form-control" required="true" placeholder="gb"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Renk</label>
                        <div class="col-md-9">
                            <form:input path="color" class="form-control" required="true" placeholder="gb"/>
                        </div>
                    </div>
                    <div class="form-group">
